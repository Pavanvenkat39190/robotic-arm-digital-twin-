...
export default function App() {
  ...
  const [faults, setFaults] = useState({ // This state comes from the backend
    overheating: 'OK',
    torqueImbalance: 'OK',
    encoderLoss: 'OK',
    powerFluctuation: 'OK',
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "var(--color-bg)", minHeight: "100vh", padding: "1rem", color: "var(--color-text-primary)" }}>
       ...
       <style>{`
        ...
        :root { /* Light Mode */
          ...
          --color-text-primary: #111827; --color-text-secondary: #4b5563; --color-text-muted: #9ca3af;
          --color-border: #e5e7eb; --color-primary: #2563eb; --color-primary-hover: #1d4ed8;
          --color-danger: #ef4444; --color-danger-bg: #fee2e2; --color-danger-text: #991b1b;
          --color-warning: #f59e0b; --color-warning-bg: #fef3c7; --color-warning-text: #92400e;
        ...
        body.dark-mode { /* Dark Mode */
          ...
          --color-text-primary: #f9fafb; --color-text-secondary: #d1d5db; --color-text-muted: #6b7280;
          --color-border: #374151; --color-primary: #3b82f6; --color-primary-hover: #2563eb;
          --color-danger: #f87171; --color-danger-bg: #450a0a; --color-danger-text: #fecaca;
          --color-warning: #fbbf24; --color-warning-bg: #422006; --color-warning-text: #fef3c7;
          --color-success: #34d399; --color-success-bg: #064e3b; --color-success-text: #d1fae5;
          --color-info-bg: #1e3a8a; --color-info-text: #dbeafe;
